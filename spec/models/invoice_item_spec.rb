  ...
  describe 'instance methods' do
    ...
    describe '#discount_id' do
      ...
      it 'works if discount exists' do
        ...
        expect(@invoice_item_1.discount_id).to eq(@discount.id)
        expect(@invoice_item_2.discount_id).to be_nil
      end
    end
  end
